"""Utility helpers for wiring WSInsight outputs into QuPath projects."""
...
def add_image_and_geojson(
    ...
    *,
    ...
    """Register an image plus its GeoJSON annotations into a QuPath project."""
...
If QuPath is not installed, please install it from https://qupath.github.io/."""
        ...
        for csv_file in csv_files:
            ...
            json_file = results_dir / "model-outputs-geojson" / (file_name + ".geojson")
