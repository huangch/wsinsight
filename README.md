...
WSInsight is a fork of [WSInfer](https://github.com/SBU-BMI/wsinfer) that delivers end-to-end pathology inference for giga-pixel whole slide images. It scales from laptops to cloud clusters, orchestrates cell detection/classification, patch extraction/classification, model inference, and downstream analytics, and produces artifacts that can be explored in QuPath, GeoJSON-aware viewers or OMERO+.
...
| **Method**            | **Architecture & Key Features**                                                                                                                                                   | **Model Weights**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | **Reference**                                                                                                                                                                     |
|-----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **CellViT**           | Vision Transformer encoder with U-Net style decoder;<br>trained on multi-tissue datasets (e.g., PanNuke);<br>supports multi-class nuclear instance segmentation & classification. | [`CellViT-256-x20`](https://huggingface.co/huangch/CellViT-256-x20),<br>[`CellViT-256-x40`](https://huggingface.co/huangch/CellViT-256-x40),<br>[`CellViT-256-x40-AMP`](https://huggingface.co/huangch/CellViT-256-x40-AMP),<br>[`CellViT-SAM-H-x20`](https://huggingface.co/huangch/CellViT-SAM-H-x20),<br>[`CellViT-SAM-H-x40`](https://huggingface.co/huangch/CellViT-SAM-H-x40),<br>[`CellViT-SAM-H-x40-AMP`](https://huggingface.co/huangch/CellViT-SAM-H-x40-AMP),<br>[`CellViT-Virchow-x40-AMP`](https://huggingface.co/huangch/CellViT-Virchow-x40-AMP) | [Ref](https://doi.org/10.1016/j.media.2024.103143)                                                                                                                                |
| **HoVer-Net**         | ResNet50 CNN backbone with dual-branch decoder;<br>predicts nuclear masks + horizontal/vertical (HoVer) distance maps;<br>improves instance separation.                           | [`hovernet_fast_pannuke`](https://huggingface.co/huangch/hovernet_fast_pannuke)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | [Ref](https://doi.org/10.1016/j.media.2019.101563)                                                                                                                                |
| **StarDist–ResNet50** | ResNet50 backbone + star-convex polygon representation;<br>predicts radial distances for nuclei delineation along fixed rays.                                                     | TBD                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | [Ref](https://link.springer.com/chapter/10.1007/978-3-030-00934-2_30), [Ref](https://openaccess.thecvf.com/content_cvpr_2016/html/He_Deep_Residual_Learning_CVPR_2016_paper.html) |
...
WSInsight as a cloud-native pipeline for single-cell pathology inference on whole-slide images. bioRxiv. https://doi.org/10.64898/2025.12.07.692260
